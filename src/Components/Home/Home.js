    ...
    return (
        <div className="container-fluid home" id="home">
            <div className="theme-changer" onClick={changeTheme}>
                {theme === "light" ? (<MdDarkMode size={40}/>) : (
            ...
            <div className="container home-content">
                ...
                <Fade bottom>
                    <div className="button-action">
                            <div className="hire-me-button no-apperance">
                                <a href="mailto:mailto:indraniko20@gmail.com"
                        ...
                        <div className="get-resume-button">
                            <a href="https://drive.google.com/drive/u/0/folders/1yqkU59923D9AKk1ctAJthidr1kWFSGAI"
                               target="_blank" rel="noreferrer">
                                Get Resume
                            </a>
                        </div>
